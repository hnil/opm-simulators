...
template class EclGenericTracerModel<Dune::PolyhedralGrid<3, 3, double>,
                                     ...
                                     EcfvStencil<double, Dune::Fem::GridPart2GridViewImpl<Dune::Fem::AdaptiveLeafGridPart<Dune::PolyhedralGrid<3, 3, double>, (Dune::PartitionIteratorType)4, false> >, false, false>,
                                     double>;

...
struct WellProxy
{
    ...
    double q_ref;          // reference rate at p_ref                 [sm3/s]
    double p_ref;          // reference node pressure                 [Pa]
...
public:
    GasInjectionNetwork()
    {
        ...
        // Calibration point: the reference, day 31 (opm-tests/eclref).
        wells_ = {
...
// The bench reproduces the reference operating point it was calibrated to,
